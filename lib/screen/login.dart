    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>ForgetPassword(widget.show)));
              },
  ...
  Widget Login_bottom() {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () async {
          User? user = await Firestore_Datasource().login(email.text, password.text);
          if (user != null) {
